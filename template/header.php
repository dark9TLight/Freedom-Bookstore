...
<html lang="en">
  ...
  <body style="background-color: gray">
    ...
    <nav class="navbar bg-info navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">IT SOURCECODE Bookstore</a>
        </div>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="category_list.php"><span class="glyphicon glyphicon-paperclip"></span>&nbsp; category</a></li>
              <!-- link to books.php -->
    ...
    <div class="jumbotron" style="background-color: gray">
      <div class="container">
        <h1>Welcome to IT SOURCECODE online bookstore</h1>
