<?php
	...
	/*
		Array of session(
			cart => array (
				book_id (get from $_POST['book_id']) => number of books
			),
			items => 0,
			total_price => '0.00'
		)
	*/
	...
	// book_id got from form post method, change this place later.
...
?>
	...
	<?php
		...
		echo '<p style="color:black !important; font-size:14px; font-family:Arial">Your cart is empty! Please make sure you add some books in it!</p>';
	}
