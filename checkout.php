<?php
	...
	/*
		Array of session(
			cart => array (
				book_id (get from $_GET['book_id']) => number of books
			),
			items => 0,
			total_price => '0.00'
		)
...
?>
	...
	<p class="lead" style="color:grey!important;">Please press Purchase to confirm your purchase, or Back to Cart to add or remove items in your cart.</p>
<?php
	} else {
